...
Atlasia precisa renascer como projeto de portfólio funcional, profissional e sustentável, preservando sua identidade cartográfica enquanto substitui a integração obsoleta por dados geográficos validados e desacoplados. O novo MVP deve demonstrar qualidade de produto, arquitetura e experiência, sem crescer além do necessário para uma primeira entrega commitável.
...
- Criar rota compartilhável e indexável para cada país, com informações geográficas organizadas em grupos compreensíveis.
...
- Servir um snapshot versionado e validado de países sem chamadas externas em runtime.
...
- `country-data-integration`: Snapshot versionado, validação Zod, normalização e atualização controlada dos dados geográficos.
...
- Exige atualização manual do snapshot quando a fonte geográfica mudar.
